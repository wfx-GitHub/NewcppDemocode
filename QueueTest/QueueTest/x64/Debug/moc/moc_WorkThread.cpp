...
QT_MOC_LITERAL(1, 11, 12), // "taskFinished"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 6) // "FTname"

    },
    "WorkThread\0taskFinished\0\0FTname"
};
...
void WorkThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->taskFinished((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkThread::taskFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkThread::taskFinished(int _t1)
{
